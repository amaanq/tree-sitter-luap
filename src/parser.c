...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_pattern, 1),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_class_pattern, 1),
  ...
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 2),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_class, 2),
  ...
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_pattern, 2),
  [225] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_class_pattern, 2),
